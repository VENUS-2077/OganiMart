    ...
    <div class="container-fluid p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-info">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><i class="fa fa-shopping-basket" aria-hidden="true"> OganiMart</i></a>
        ...
        <div class="bg-light p-2 mt-2">
            <p class="text-center">Splash into Savings this Holi Season with OganiMart!!!</p>
        </div>
